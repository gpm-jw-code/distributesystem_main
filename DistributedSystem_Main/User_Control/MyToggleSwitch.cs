...
namespace USC_ModulePart
{
    public class MyToggleSwitch : Control
    {
        ...
        public MyToggleSwitch()
        {
            ...
            this.artis = 4f;
            this.diameter = 30f;
            this.rect = new MyRectangle(2f * diameter, diameter + 2f, diameter / 2f, 1f, 1f);
            this.circle = new RectangleF(1f, 1f, diameter, diameter);
            this.isON = false;
        ...
        public void SliderValueChangedInvoke()
        {
